...
@RestController
@RequestMapping("/api/v1/{workoutId}/exercises")
...
public class ExerciseController {
    ...
    @PatchMapping("/")
    public ResponseEntity<?> updateExercise(@RequestBody ExerciseRequest request, @PathVariable Long workoutId, @RequestParam Long exerciseId, Authentication connectedUser) {

        return ResponseEntity.ok(exerciseService.editExercise(exerciseId, connectedUser, request));
    }

    @DeleteMapping("/")
    public ResponseEntity<Map<String, String>> deleteExercise(@PathVariable Long workoutId, @RequestParam Long exerciseId, Authentication connectedUser) {
...
//    public ResponseEntity<?> uploadImage(@PathVariable Long workoutId, @RequestParam("file") MultipartFile file, Authentication connectedUser) throws IOException {
//
